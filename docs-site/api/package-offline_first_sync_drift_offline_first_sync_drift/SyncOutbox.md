---
title: "SyncOutbox"
description: "API documentation for SyncOutbox class from offline_first_sync_drift"
category: "Classes"
library: "offline_first_sync_drift"
sourceUrl: "https://github.com/cherrypick-agency/synchronize_cache/blob/main/packages/offline_first_sync_drift/lib/src/tables/outbox.dart#L7"
outline: [2, 3]
editLink: false
prev: false
next: false
...
<div class="member-signature"><pre><code><span class="kw">class</span> <span class="fn">SyncOutbox</span> <span class="kw">extends</span> <span class="type">Table</span></code></pre></div>

**Annotations:** `@UseRowClass(SyncOutboxData)`

Outbox table for synchronization operations.
Stores local changes until they are sent to the server.

:::info Inheritance
Object → HasResultSet → Table → **SyncOutbox**
:::

## Constructors {#section-constructors}

### SyncOutbox() {#ctor-syncoutbox}

<div class="member-signature"><pre><code><span class="fn">SyncOutbox</span>()</code></pre></div>

## Properties {#section-properties}

### baseUpdatedAt <Badge type="tip" text="no setter" /> {#prop-baseupdatedat}

<div class="member-signature"><pre><code><span class="type">IntColumn</span>&lt;<span class="type">int</span>&gt; <span class="kw">get</span> <span class="fn">baseUpdatedAt</span></code></pre></div>
...
### changedFields <Badge type="tip" text="no setter" /> {#prop-changedfields}

<div class="member-signature"><pre><code><span class="type">TextColumn</span>&lt;<span class="type">String</span>&gt; <span class="kw">get</span> <span class="fn">changedFields</span></code></pre></div>
...
you override [primaryKey](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutbox#prop-primarykey). You can turn this behavior off if you want to.
...
### entityId <Badge type="tip" text="no setter" /> {#prop-entityid}

<div class="member-signature"><pre><code><span class="type">TextColumn</span>&lt;<span class="type">String</span>&gt; <span class="kw">get</span> <span class="fn">entityId</span></code></pre></div>
...
that affects [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutbox#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutbox#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutbox#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutbox#operator-equals).
...
If a subclass overrides [hashCode](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutbox#prop-hashcode), it should override the
[operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutbox#operator-equals) operator as well to maintain consistency.
...
### kind <Badge type="tip" text="no setter" /> {#prop-kind}

<div class="member-signature"><pre><code><span class="type">TextColumn</span>&lt;<span class="type">String</span>&gt; <span class="kw">get</span> <span class="fn">kind</span></code></pre></div>
...
### op <Badge type="tip" text="no setter" /> {#prop-op}

<div class="member-signature"><pre><code><span class="type">TextColumn</span>&lt;<span class="type">String</span>&gt; <span class="kw">get</span> <span class="fn">op</span></code></pre></div>
...
### opId <Badge type="tip" text="no setter" /> {#prop-opid}

<div class="member-signature"><pre><code><span class="type">TextColumn</span>&lt;<span class="type">String</span>&gt; <span class="kw">get</span> <span class="fn">opId</span></code></pre></div>
...
### payload <Badge type="tip" text="no setter" /> {#prop-payload}

<div class="member-signature"><pre><code><span class="type">TextColumn</span>&lt;<span class="type">String</span>&gt; <span class="kw">get</span> <span class="fn">payload</span></code></pre></div>
...
### primaryKey <Badge type="tip" text="no setter" /> <Badge type="info" text="override" /> {#prop-primarykey}
...
### tableName <Badge type="tip" text="no setter" /> <Badge type="info" text="override" /> {#prop-tablename}
...
### tryCount <Badge type="tip" text="no setter" /> {#prop-trycount}

<div class="member-signature"><pre><code><span class="type">IntColumn</span>&lt;<span class="type">int</span>&gt; <span class="kw">get</span> <span class="fn">tryCount</span></code></pre></div>
...
### ts <Badge type="tip" text="no setter" /> {#prop-ts}

<div class="member-signature"><pre><code><span class="type">IntColumn</span>&lt;<span class="type">int</span>&gt; <span class="kw">get</span> <span class="fn">ts</span></code></pre></div>
...
When two rows have the same value in *any*  set specified in [uniqueKeys](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutbox#prop-uniquekeys),
