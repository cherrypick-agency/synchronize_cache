---
title: "SyncOutboxMetaCompanion"
description: "API documentation for SyncOutboxMetaCompanion class from offline_first_sync_drift"
category: "Classes"
library: "offline_first_sync_drift"
sourceUrl: "https://github.com/cherrypick-agency/synchronize_cache/blob/main/packages/offline_first_sync_drift/lib/src/tables/outbox_meta.drift.dart#L308"
outline: [2, 3]
editLink: false
prev: false
next: false
...
# SyncOutboxMetaCompanion

<div class="member-signature"><pre><code><span class="kw">class</span> <span class="fn">SyncOutboxMetaCompanion</span> <span class="kw">extends</span> <span class="type">UpdateCompanion</span>&lt;<a href="/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMetaData" class="type-link">SyncOutboxMetaData</a>&gt;</code></pre></div>

:::info Inheritance
Object → UpdateCompanion\<D\> → **SyncOutboxMetaCompanion**
:::

## Constructors {#section-constructors}

### SyncOutboxMetaCompanion() <Badge type="tip" text="const" /> {#ctor-syncoutboxmetacompanion}

<div class="member-signature"><pre><code><span class="kw">const</span> <span class="fn">SyncOutboxMetaCompanion</span>({
  <span class="type">Value</span>&lt;<span class="type">String</span>&gt; <span class="param">opId</span> = const i0.Value.absent(),
  <span class="type">Value</span>&lt;<span class="type">int</span>?&gt; <span class="param">lastTriedAt</span> = const i0.Value.absent(),
  <span class="type">Value</span>&lt;<span class="type">String</span>?&gt; <span class="param">lastError</span> = const i0.Value.absent(),
...
### SyncOutboxMetaCompanion.insert() {#insert}

<div class="member-signature"><pre><code><span class="fn">SyncOutboxMetaCompanion.insert</span>({
...
that affects [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMetaCompanion#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMetaCompanion#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMetaCompanion#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMetaCompanion#operator-equals).
...
If a subclass overrides [hashCode](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMetaCompanion#prop-hashcode), it should override the
[operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMetaCompanion#operator-equals) operator as well to maintain consistency.
...
### lastError <Badge type="tip" text="final" /> {#prop-lasterror}

<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">Value</span>&lt;<span class="type">String</span>?&gt; <span class="fn">lastError</span></code></pre></div>
...
### lastTriedAt <Badge type="tip" text="final" /> {#prop-lasttriedat}

<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">Value</span>&lt;<span class="type">int</span>?&gt; <span class="fn">lastTriedAt</span></code></pre></div>
...
<div class="member-signature"><pre><code><a href="/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMetaCompanion" class="type-link">SyncOutboxMetaCompanion</a> <span class="fn">copyWith</span>({
  <span class="type">Value</span>&lt;<span class="type">String</span>&gt;? <span class="param">opId</span>,
  <span class="type">Value</span>&lt;<span class="type">int</span>?&gt;? <span class="param">lastTriedAt</span>,
  <span class="type">Value</span>&lt;<span class="type">String</span>?&gt;? <span class="param">lastError</span>,
...
the [hashCode](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMetaCompanion#prop-hashcode) method as well to maintain consistency.
...
<div class="member-signature"><pre><code><span class="type">Insertable</span>&lt;<a href="/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMetaData" class="type-link">SyncOutboxMetaData</a>&gt; <span class="fn">custom</span>({
  <span class="type">Expression</span>&lt;<span class="type">String</span>&gt;? <span class="param">opId</span>,
  <span class="type">Expression</span>&lt;<span class="type">int</span>&gt;? <span class="param">lastTriedAt</span>,
  <span class="type">Expression</span>&lt;<span class="type">String</span>&gt;? <span class="param">lastError</span>,
