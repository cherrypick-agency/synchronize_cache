---
title: "SynchronizableTable"
description: "API documentation for SynchronizableTable class from offline_first_sync_drift"
category: "Classes"
library: "offline_first_sync_drift"
sourceUrl: "https://github.com/cherrypick-agency/synchronize_cache/blob/main/packages/offline_first_sync_drift/lib/src/tables/sync_columns.dart#L6"
outline: [2, 3]
editLink: false
prev: false
next: false
...
# SynchronizableTable <Badge type="info" text="abstract" /> <Badge type="info" text="interface" />

<div class="member-signature"><pre><code><span class="kw">abstract</span> <span class="kw">interface</span> <span class="kw">class</span> <span class="fn">SynchronizableTable</span></code></pre></div>
...
:::info Implementers
- [SyncColumns](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncColumns)
:::

## Properties {#section-properties}

### deletedAt <Badge type="tip" text="no setter" /> {#prop-deletedat}
...
### deletedAtLocal <Badge type="tip" text="no setter" /> {#prop-deletedatlocal}
...
that affects [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SynchronizableTable#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SynchronizableTable#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SynchronizableTable#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SynchronizableTable#operator-equals).
...
If a subclass overrides [hashCode](/api/package-offline_first_sync_drift_offline_first_sync_drift/SynchronizableTable#prop-hashcode), it should override the
[operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SynchronizableTable#operator-equals) operator as well to maintain consistency.
...
### updatedAt <Badge type="tip" text="no setter" /> {#prop-updatedat}
