---
title: "SyncEntityWriter<T, DB extends GeneratedDatabase>"
description: "API documentation for SyncEntityWriter<T, DB extends GeneratedDatabase> class from offline_first_sync_drift"
category: "Classes"
library: "offline_first_sync_drift"
sourceUrl: "https://github.com/cherrypick-agency/synchronize_cache/blob/main/packages/offline_first_sync_drift/lib/src/sync_writer.dart#L50"
outline: [2, 3]
editLink: false
prev: false
next: false
...
# SyncEntityWriter\<T, DB extends GeneratedDatabase\>

<div class="member-signature"><pre><code><span class="kw">class</span> <span class="fn">SyncEntityWriter</span>&lt;T, DB <span class="kw">extends</span> <span class="type">GeneratedDatabase</span>&gt;</code></pre></div>
...
that affects [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncEntityWriter#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncEntityWriter#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncEntityWriter#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncEntityWriter#operator-equals).
...
If a subclass overrides [hashCode](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncEntityWriter#prop-hashcode), it should override the
[operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncEntityWriter#operator-equals) operator as well to maintain consistency.
...
<div class="member-signature"><pre><code><span class="type">Future</span>&lt;<span class="type">void</span>&gt; <span class="fn">enqueueDelete</span>({
...
### insertAndEnqueue() {#insertandenqueue}

<div class="member-signature"><pre><code><span class="type">Future</span>&lt;<span class="type">void</span>&gt; <span class="fn">insertAndEnqueue</span>(
...
### replaceAndEnqueue() {#replaceandenqueue}

<div class="member-signature"><pre><code><span class="type">Future</span>&lt;<span class="type">void</span>&gt; <span class="fn">replaceAndEnqueue</span>(
  <span class="type">T</span> <span class="param">entity</span>, {
...
### replaceAndEnqueueDiff() {#replaceandenqueuediff}

<div class="member-signature"><pre><code><span class="type">Future</span>&lt;<span class="type">void</span>&gt; <span class="fn">replaceAndEnqueueDiff</span>({
...
### writeAndEnqueueDelete() {#writeandenqueuedelete}

<div class="member-signature"><pre><code><span class="type">Future</span>&lt;<span class="type">void</span>&gt; <span class="fn">writeAndEnqueueDelete</span>({
...
### writeAndEnqueueOp() {#writeandenqueueop}

<div class="member-signature"><pre><code><span class="type">Future</span>&lt;<span class="type">void</span>&gt; <span class="fn">writeAndEnqueueOp</span>({
  <span class="kw">required</span> <span class="type">Future</span>&lt;<span class="type">void</span>&gt; <span class="type">Function</span>() <span class="param">localWrite</span>,
  <span class="kw">required</span> <a href="/api/package-offline_first_sync_drift_offline_first_sync_drift/Op" class="type-link">Op</a> <span class="param">op</span>,
})</code></pre></div>
