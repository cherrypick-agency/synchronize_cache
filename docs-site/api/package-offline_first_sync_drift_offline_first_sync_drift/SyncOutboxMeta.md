---
title: "SyncOutboxMeta"
description: "API documentation for SyncOutboxMeta class from offline_first_sync_drift"
category: "Classes"
library: "offline_first_sync_drift"
sourceUrl: "https://github.com/cherrypick-agency/synchronize_cache/blob/main/packages/offline_first_sync_drift/lib/src/tables/outbox_meta.dart#L9"
outline: [2, 3]
editLink: false
prev: false
next: false
...
<div class="member-signature"><pre><code><span class="kw">class</span> <span class="fn">SyncOutboxMeta</span> <span class="kw">extends</span> <span class="type">Table</span></code></pre></div>

**Annotations:** `@UseRowClass(SyncOutboxMetaData)`
...
:::info Inheritance
Object → HasResultSet → Table → **SyncOutboxMeta**
:::

## Constructors {#section-constructors}

### SyncOutboxMeta() {#ctor-syncoutboxmeta}

<div class="member-signature"><pre><code><span class="fn">SyncOutboxMeta</span>()</code></pre></div>
...
you override [primaryKey](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMeta#prop-primarykey). You can turn this behavior off if you want to.
...
that affects [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMeta#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMeta#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMeta#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMeta#operator-equals).
...
If a subclass overrides [hashCode](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMeta#prop-hashcode), it should override the
[operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMeta#operator-equals) operator as well to maintain consistency.
...
### lastError <Badge type="tip" text="no setter" /> {#prop-lasterror}

<div class="member-signature"><pre><code><span class="type">TextColumn</span>&lt;<span class="type">String</span>&gt; <span class="kw">get</span> <span class="fn">lastError</span></code></pre></div>
...
### lastTriedAt <Badge type="tip" text="no setter" /> {#prop-lasttriedat}

<div class="member-signature"><pre><code><span class="type">IntColumn</span>&lt;<span class="type">int</span>&gt; <span class="kw">get</span> <span class="fn">lastTriedAt</span></code></pre></div>
...
When two rows have the same value in *any*  set specified in [uniqueKeys](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncOutboxMeta#prop-uniquekeys),
