---
title: "MaxRetriesExceededException"
description: "API documentation for MaxRetriesExceededException class from offline_first_sync_drift"
category: "Exceptions"
library: "offline_first_sync_drift"
sourceUrl: "https://github.com/cherrypick-agency/synchronize_cache/blob/main/packages/offline_first_sync_drift/lib/src/exceptions.dart#L127"
outline: [2, 3]
editLink: false
prev: false
next: false
...
<div class="member-signature"><pre><code><span class="kw">class</span> <span class="fn">MaxRetriesExceededException</span> <span class="kw">extends</span> <a href="/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncException" class="type-link">SyncException</a></code></pre></div>

Maximum retry attempts exceeded.

:::info Inheritance
Object → [SyncException](/api/package-offline_first_sync_drift_offline_first_sync_drift/SyncException) → **MaxRetriesExceededException**
:::

## Constructors {#section-constructors}

### MaxRetriesExceededException() <Badge type="tip" text="const" /> {#ctor-maxretriesexceededexception}

<div class="member-signature"><pre><code><span class="kw">const</span> <span class="fn">MaxRetriesExceededException</span>(
  <span class="type">String</span> <span class="param">message</span>, {
  <span class="kw">required</span> <span class="type">int</span> <span class="param">attempts</span>,
  <span class="kw">required</span> <span class="type">int</span> <span class="param">maxRetries</span>,
...
### attempts <Badge type="tip" text="final" /> {#prop-attempts}

<div class="member-signature"><pre><code><span class="kw">final</span> <span class="type">int</span> <span class="fn">attempts</span></code></pre></div>
...
that affects [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/MaxRetriesExceededException#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/MaxRetriesExceededException#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/MaxRetriesExceededException#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/MaxRetriesExceededException#operator-equals).
...
If a subclass overrides [hashCode](/api/package-offline_first_sync_drift_offline_first_sync_drift/MaxRetriesExceededException#prop-hashcode), it should override the
[operator ==](/api/package-offline_first_sync_drift_offline_first_sync_drift/MaxRetriesExceededException#operator-equals) operator as well to maintain consistency.
